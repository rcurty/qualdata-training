...
::: {.callout-note collapse="true" appearance="simple" icon="false"}
Let's open the files for `interviewee_01` and `interviewee_03` ([Sara-Project/Data](https://drive.google.com/drive/folders/1SBxXcMPnNdSHDxUFsMfl5u7cTwAzLskT)). To make things easier, we have highlighted some potential sensitive pieces of information. How we would mitigate those issues?

The [Data-Qualcoder](https://drive.google.com/drive/folders/1736eI0a61UkAsMX1sxvbWPzKGVUzrymD) folder contains a possible solution. **(FIXME-ADD SOLLUTION FILE)**
:::
:::
