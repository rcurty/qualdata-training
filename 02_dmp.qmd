...
Source: UCSB Library Data Literacy Series ([perma.cc/CT8P-D5MK](https://perma.cc/CT8P-D5MK)).
...
Source: UCSB Library Data Literacy Series ([perma.cc/3HFE-6X7U](https://perma.cc/3HFE-6X7U)).
...
It is worth noting that the DMPTool is free of use to anyone, and that non-UCSB affiliates can be added as collaborators and reviewers if you'd like. We ask you to log in with your UCSB account, so you can take advantage of campus-specific guidance and resources to develop you data management plan. 
...
For future reference, you may find valuable insights by consulting the list of the [11 winning DMPs](https://blog.dmptool.org/2021/05/19/dmp-competition-winners-dmps-so-good-they-go-to-11) from the DMPTool Qualitative Data Competition. These exemplary DMPs showcase best practices and innovative approaches in managing qualitative data, offering a valuable benchmark for developing your own plan.
