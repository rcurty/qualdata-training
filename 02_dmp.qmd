...
The ultimate goal is that researchers will make more informed decisions on how to produce and share data satisfying the FAIR principles, which essentially aims to ensure that the data is:

-   **F**indable: It is published on an stable location and indexed
