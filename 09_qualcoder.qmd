...
Once you follow those instructions, since we will be using a Windows virtual machine, you will need to launch the command prompt and type `py -m qualcoder` to start QualCoder.
