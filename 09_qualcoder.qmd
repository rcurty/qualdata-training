...
To save time, for this workshop, we will skip the installation process and grant learners access to a virtual machine with QualCoder pre-installed. We will first use the latest available version of the software (currently 3.5) for the coding activities and then give a sneak peak of the beta version with AI capabilities to demonstrate how ChatGPT 4.0 can assist with horizontal coding.
