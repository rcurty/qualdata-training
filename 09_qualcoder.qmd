...
We've created a project but don't have any files yet, so let's load them now. Click the Manage menu, choose and manage files, and then, the second icon as noted below (Import File Into Project Folder), select the desired folder and files.
