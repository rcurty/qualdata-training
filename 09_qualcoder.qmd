...
-   Wiki - <https://github.com/ccbogel/QualCoder/wiki>{target='_blank'}

-   GitHub Repository - <https://github.com/ccbogel/QualCoder>{target='_blank'}

-   GitHub Repository (QualCoder AI - beta) - <https://github.com/kaixxx/QualCoder/tree/ai_integration>{target='_blank'}
...
To save time, for the in-person workshop, we will skip the installation process for Mac users that did not come to the session with the software pre-installed, and grant them access to a virtual machine with QualCoder pre-installed.

You should have:

 1) Windows App downloaded on your laptop 
 2) Access DUO Multifactor Authentication, as this will be required to launch the virtual machine.
 3) An email invitation to join the Virtual Machine

Have these available, and follow [Virtual Machine Setup - Mac users](https://www.library.ucsb.edu/sites/default/files/azure_lab_login_mac_instructions_w2024.pdf) instructions. 
...
Other helpful tutorials can be found here: <https://github.com/ccbogel/QualCoder/wiki/15-QualCoder-videos>{target='_blank'}
