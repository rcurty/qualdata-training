...
::: callout-important
## A Note About Context & Recontextualization

Reusing qualitative data is more effective and often times, only possible, when detailed contextual information is provided. The focus is not on recreating the original context but on recontextualizing the data for new research. Bishop (2007) emphasizes that context needs to be considered at two points: the original project's time and the contemporary project. There are three levels of context to address: interactional (researcher-participant dynamics), situational (research setting), and cultural/institutional (broader environment).
:::
...
Researchers interested in reusing qualitative human subject (QHS) data need to pay special attention to the following:
