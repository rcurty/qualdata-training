...
::: {.callout-note collapse="true" appearance="simple" icon="false"}
Let's open the files for `interviewee_01` and `interviewee_03` ([Sara-Project/Data](https://drive.google.com/drive/folders/1SBxXcMPnNdSHDxUFsMfl5u7cTwAzLskT)). To make things easier, we have highlighted some potential sensitive pieces of information. What strategies can we implement to minimize the risk of interviewees' identification?

The [Data-Qualcoder-Deid](https://drive.google.com/drive/folders/1yYlgtlQ0lvw7Iify7-XydBwpGSkgxwGg?usp=drive_link) folder contains a possible solution.
:::
:::
