...
Understanding the roles of files, attributes and cases and their relationships is key to most QDA software, including Qualcoder. In Qualcoder, **files** refer to the individual documents or data sources you import for analysis. You may have more than one file associate with a unique case. Let's imagine that Sarah also collected shared posts from content creators/digital influencers to analyze their actual use of the platform to engage with followers and aid to the analysis. Sarah could have those multiple documents associated with one specific interviewee (case).

**Attributes** are metadata or characteristics assigned to these files or cases, helping to categorize or describe them. **Cases** are specific units of analysis, often linked to files, that allow you to organize and explore your data in a more detailed manner. Together, they create a structured environment for qualitative analysis, allowing you to delve into themes and patterns effectively.
