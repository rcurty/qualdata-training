...
Now that we are more familiar with the interface and affordances of QualCoder and the mechanics of setting up a project and using some basic features, let's help Sarah on how she can use the tool to code her transcripts.
