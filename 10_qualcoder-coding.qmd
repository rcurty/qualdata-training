...
Before we move forward, please download the influencers_q4.qda **\[fixme: add to the folder\]** project and open it.

QualCoder offers a few options for users to export, query and visualize the data. It can provide code counting summaries in a variety of formats, word clouds, plotting in bars and pie charts, and it also supports intercoder reliability testing. Let's see show Sarah some of the options she might want to consider for her analysis.
