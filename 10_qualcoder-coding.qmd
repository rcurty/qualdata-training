...
So, we will start by creating this first set of codes in QualCoder. To do that, let's do a ctrl+click on the panel.

![](images/new-code.png)

Complete the same process for the other codes. You will notice that

Then, choose `add new code` and type the first one on the list above. You will notice
