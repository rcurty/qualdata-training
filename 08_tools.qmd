...
Below we compare the top most popular open-source free tool: [Qualcoder](https://qualcoder.wordpress.com){target='_blank'} and [Taguette](https://www.taguette.org){target='_blank'}.
